...
const CheckboxComponent = /*#__PURE__*/React.memo(({
  ...
  const [accessibilityProps, nonAccessibilityProps] = extractInObject(nonLayoutProps, ['accessibilityRole', 'accessibilityState', 'accessibilityLabel']); //TODO: refactor for responsive prop
